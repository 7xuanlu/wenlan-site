...
|---|---|
| Resume / choose next work | [Successor deadline and stop conditions](../SEO-CAMPAIGN.md#successor-goal-contract); current Space Brief; [recovery queue](seo-growth-recovery.md); exact relevant record in [experiment ledger](../EXPERIMENTS.md). Old "current" headings are not fresh state. |
| Choose content or distribution | [Six demand questions](seo-product-evidence-standard.md#demand-decision-before-implementation), [candidate gate](../SEO-CAMPAIGN.md#candidate-gate), [acquisition focus](../SEO-CAMPAIGN.md#acquisition-focus). |
