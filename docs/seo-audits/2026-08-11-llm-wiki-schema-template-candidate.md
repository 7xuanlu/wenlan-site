...
First publish and production-verify, or explicitly release, the prepared
`v0.15.8` technical correction. Then review the exact three-language refresh
diff and seek separate approval for commit, push, PR, merge, automatic Vercel
deployment, and production verification.

No website content, commit, push, PR, merge, deployment, indexing request,
GSC validation, external publication, paid action, synthetic event, analytics
mutation, or metric-definition change occurred in this candidate audit.
