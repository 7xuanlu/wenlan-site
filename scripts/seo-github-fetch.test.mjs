...
const currentAssets = [
  ...
  ["Wenlan_0.17.5_aarch64.dmg", 2],
  ["Wenlan_0.17.5_x64-setup.exe", 1],
  ...
  try {
    ...
    const metadata = buildGithubMetadata({
      ...
      releases: [
          {
            tag_name: "v0.17.5",
            published_at: "2026-08-30T04:02:06Z",
    ...
    assert.equal(metadata.currentRelease.tag, "v0.17.5");
    ...
    assert.match(report, /Website-linked v0\.17\.5 asset downloads \| 28/);
