...
export function workedExampleSections(locale: Locale): LearnArticleSection[] {
  const copy = {
    ...
    "zh-TW": {
      ...
      change: "接著依下方內容新增 api-v2.md，讓它取代 api-v1.md。第二次提問：「以 api-v2.md、decision-07.md 與 runbook-v1.md 為目前來源，將 api-v1.md 僅作歷史參考，對照先前的 wiki 答案與目前證據，找出過時結論，保留『最多重試 1 次』與『3 次』尚未解決的矛盾；不要默默修改 decision-07.md，也不要替這項矛盾下定論。」",
    ...
    "zh-CN": {
      ...
      change: "然后按下方内容新增 api-v2.md，让它替代 api-v1.md。第二次提问：“以 api-v2.md、decision-07.md 和 runbook-v1.md 作为当前来源，把 api-v1.md 仅作历史参考，对照之前的 wiki 答案与当前证据，找出过时结论，保留‘最多重试 1 次’与‘3 次’尚未解决的冲突；不要默默修改 decision-07.md，也不要替这项冲突下结论。”",
