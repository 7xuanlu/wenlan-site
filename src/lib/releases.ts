const WENLAN_RELEASE_DOWNLOAD_BASE =
  "https://github.com/7xuanlu/wenlan/releases/download/v0.15.0";

export const WENLAN_RELEASE = {
  version: "0.15.0",
  tag: "v0.15.0",
  publishedAt: "2026-07-26",
  releaseUrl: "https://github.com/7xuanlu/wenlan/releases/tag/v0.15.0",
  setupGuideUrl:
    "https://github.com/7xuanlu/wenlan/blob/v0.15.0/docs/setup-with-ai.md#install-the-runtime",
  assets: [
    {
      id: "windows-x64",
