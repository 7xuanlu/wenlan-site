...
const baseArticles: LearnArticle[] = [
  ...
  },
  {
    ...
    heroBullets: [
      ...
      "This page reflects Basic Memory's public docs from the 2026-06-24 source check and Wenlan v0.12.0 as of 2026-07-08. If something has shifted on either side, please open an issue.",
    ],
    officialReferences: [
      {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Reflects Basic Memory's public docs from the 2026-06-24 source check and Wenlan v0.12.0 as of 2026-07-08. If something material changes on either side, please open an issue on github.com/7xuanlu/wenlan and I will update.",
      },
    ],
    relatedSlugs: [
  ...
  },
  {
    ...
    heroBullets: [
      ...
      "Both products are early. This page covers the claude-mem npm package from the 2026-06-24 source check and Wenlan v0.12.0 as of 2026-07-08.",
    ],
    officialReferences: [
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Wenlan's eval harness lives under `crates/wenlan-core/src/eval/` and runs locally on demand against the same fixtures the published numbers use. Anyone can re-run them. I refresh the published number when a release changes it materially. Last refresh: v0.12.0 on 2026-07-08.",
      },
    ],
    relatedSlugs: [
      "local-first-ai-memory",
