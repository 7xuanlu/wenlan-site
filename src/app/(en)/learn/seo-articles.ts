...
const workflowArticles: BaseSpec[] = [
  ...
  },
  {
    ...
    actionIntro:
      "Start with one bounded project topic and one inspectable document set. Prove the complete read, cite, verify, and refresh loop before adding more material.",
    actionBullets: [
