...
function makeArticle(spec: BaseSpec): LearnArticle {
  return {
    ...
    sections: [
      {
        ...
        body: [spec.quickAnswer, spec.originFit],
      },
      {
    ...
    cta: {
      ...
      body: "Install Origin, connect your AI client, and verify that capture, recall, and handoff work on your machine.",
    },
  };
}
...
const setupArticles: BaseSpec[] = [
  {
    slug: "where-origin-stores-claude-code-memory",
    eyebrow: "Setup",
    category: "Workflows",
    ...
    officialReferences: [
      ...
      {
        label: "Origin daemon data layout",
        href: "https://github.com/7xuanlu/origin/blob/main/crates/origin-server/README.md",
      },
    ],
  },
  {
    ...
    metaTitle: "How to Add Memory to Claude Code | Origin",
    metaDescription:
      "Add local-first AI work memory to Claude Code with the Origin plugin, /init, /brief, /capture, /recall, and /handoff.",
    keywords: [
      "add memory to Claude Code",
      "Claude Code memory plugin",
      "Claude Code persistent memory",
      "Origin Claude Code setup",
  ...
  },
  {
    ...
    metaTitle: "How to Give Codex Persistent Memory | Origin",
    metaDescription:
      "Use Origin with Codex by installing the local runtime, adding the Codex MCP client config, and verifying context, capture, and recall.",
    keywords: [
    ...
    relatedSlugs: ["mcp-memory-server", "origin-codex-workflow", "codex-claude-code-shared-memory"],
    officialReferences: [
      {
  ...
  },
  {
    ...
    faq: [
      "Can Cursor and Claude Code use the same Origin memory?",
  ...
  },
  {
    ...
    eyebrow: "Setup",
    category: "Workflows",
    title: "Claude Desktop MCP Memory Setup with Origin",
    description:
      "Connect Claude Desktop to Origin's local memory daemon through MCP and verify the first memory loop.",
    metaTitle: "Claude Desktop MCP Memory Setup | Origin",
    metaDescription:
      "Set up Claude Desktop with Origin MCP memory using the local runtime, origin mcp add claude-desktop, and a doctor/capture/recall check.",
    keywords: [
      "Claude Desktop MCP memory",
      "Claude Desktop memory server",
      "Claude Desktop Origin setup",
    ...
    code: {
      ...
      code: "npx -y @7xuanlu/origin setup\n~/.origin/bin/origin mcp add claude-desktop\n~/.origin/bin/origin mcp add claude-desktop --dry-run",
    },
    caution:
    ...
    faq: [
      ...
      "It can call Origin MCP tools for page distillation when configured. Background distill cycles and richer page synthesis require a local model or explicit API-key path; readable pages are still written by the local Origin daemon.",
    ],
    relatedSlugs: ["origin-claude-desktop-workflow", "mcp-memory-server", "local-first-ai-memory"],
    officialReferences: [
      {
  ...
  },
  {
    ...
    metaTitle: "AI Agent Memory: Local vs Cloud | Origin",
    metaDescription:
      "Compare local-first AI agent memory with hosted memory services and learn when Origin's local daemon is the right fit.",
    keywords: [
    ...
    relatedSlugs: ["local-first-ai-memory", "origin-vs-chatgpt-memory", "origin-vs-mem0"],
    officialReferences: [
      {
        label: "Origin data and privacy docs",
  ...
  },
  {
    ...
    metaTitle: "Why AI Coding Agents Lose Context | Origin",
    metaDescription:
      "AI coding agents lose context when work lives only in chat history. Origin captures decisions, lessons, handoffs, and project facts locally.",
    keywords: [
    ...
    officialReferences: [
      {
        label: "Origin daily workflow docs",
  ...
  },
  {
    ...
    metaTitle: "Persistent Project Context for AI Agents | Origin",
    metaDescription:
      "Learn what persistent project context means for AI agents and how Origin keeps decisions, lessons, handoffs, and pages available locally.",
    keywords: [
    ...
    faq: [
      ...
      "No. README files document public or contributor-facing facts. Origin carries session-level working context that changes while AI work happens.",
      "Can multiple tools share one project context?",
      "Yes, when they are configured to use the same local Origin daemon. That means local cross-tool continuity, not automatic cloud or team sync.",
    ],
  ...
  },
  {
    ...
    officialReferences: [
      {
        label: "Origin CLI and service docs",
      ...
      {
        label: "Origin troubleshooting docs",
        href: "https://useorigin.app/docs/troubleshooting",
      },
      {
        label: "Origin configuration docs",
        href: "https://useorigin.app/docs/configuration",
      },
      {
        label: "Origin security docs",
  ...
  },
  {
    ...
    metaTitle: "What to Capture in AI Work Memory | Origin",
    metaDescription:
      "Capture decisions, lessons, gotchas, preferences, constraints, and durable facts in Origin. Skip logs, filler, and facts the repo can derive.",
    keywords: [
    ...
    audience: "Origin users building better memory habits",
    heroBullets: [
    ...
    officialReferences: [
      {
        label: "Origin capture quality docs",
...
const workflowArticles: BaseSpec[] = [
  {
    slug: "origin-codex-workflow",
    eyebrow: "Workflow",
    category: "Workflows",
    title: "Origin Workflow for Codex",
    description:
      "Use Origin with Codex for session context, durable captures, recall, and cross-tool handoff.",
    metaTitle: "Origin Workflow for Codex | Persistent AI Work Memory",
    metaDescription:
      "A practical Origin workflow for Codex users: connect MCP, load context, capture decisions, recall project memory, and hand off to future sessions.",
    keywords: [
      "Origin Codex workflow",
  ...
  {
    slug: "origin-cursor-workflow",
    eyebrow: "Workflow",
    category: "Workflows",
    title: "Origin Workflow for Cursor",
    description:
      "Use Origin from Cursor to keep project memory available across edits, branches, and future AI sessions.",
    metaTitle: "Origin Workflow for Cursor | Local AI Work Memory",
    metaDescription:
      "A Cursor workflow for Origin: connect MCP, load context, capture decisions, recall prior work, and share memory with Claude Code or Codex.",
    keywords: [
      "Origin Cursor workflow",
    ...
    heroBullets: [
      "Connect Cursor to Origin's MCP connector, which talks to the local daemon.",
      "Capture decisions while editing instead of after the context is gone.",
      "Use the same memory from Claude Code or Codex later.",
    ],
    quickAnswer:
      "Use Origin in Cursor as a local project-memory companion outside the editor: ask Cursor Agent to use Origin context, capture durable changes, recall previous decisions, and keep handoff facts available for other tools.",
    problem:
      "Cursor has native Memories and Rules for Cursor-scoped context. Origin's role is different: keep inspectable local work memory available to Cursor, Claude Code, Codex, and other MCP clients through one daemon.",
    originFit:
      "Origin fills that gap with a local memory layer outside the editor. Cursor can use the same decisions, pages, and handoffs as other MCP clients.",
    actionHeading: "Use Cursor with a memory habit",
    actionIntro:
      "Add memory at the points where future confusion is likely.",
    actionBullets: [
      "Ask Cursor Agent to use Origin context before a meaningful feature or bugfix, approving the MCP tool call if prompted.",
    ...
    caution:
      "Do not make Origin a second task tracker. Store durable context for future agents, not every temporary edit in the current branch.",
    faq: [
      "Why use Origin if Cursor can read files?",
      "Cursor-native memory helps inside Cursor. Origin keeps inspectable, local, cross-client work memory outside the editor so Claude Code, Codex, and other MCP clients can use the same context.",
      "Can Cursor use distilled pages?",
      "Yes, once pages have been created through Origin's distill/page workflow. Cursor can retrieve them through Origin MCP.",
    ],
  ...
  {
    slug: "origin-claude-desktop-workflow",
    eyebrow: "Workflow",
    category: "Workflows",
    title: "Origin Workflow for Claude Desktop",
    description:
      "Use Claude Desktop with Origin MCP memory for planning, research, and handoff context that later coding agents can reuse.",
    metaTitle: "Origin Workflow for Claude Desktop | MCP Memory",
    metaDescription:
      "Claude Desktop can use Origin through MCP to capture planning decisions, recall local context, and share memory with coding tools.",
    keywords: [
      "Origin Claude Desktop workflow",
      "Claude Desktop memory workflow",
      "Claude Desktop MCP memory",
      "Claude Desktop persistent memory",
      "Origin MCP Claude Desktop",
    ],
    audience: "Claude Desktop users who plan or research before coding",
    heroBullets: [
      "Use Claude Desktop for planning while Origin stores durable decisions locally.",
    ...
    quickAnswer:
      "Claude Desktop works best with Origin after it is connected to the same local daemon and relevant space as your coding clients. Capture planning outcomes and project decisions that later coding sessions should inherit.",
    problem:
    ...
    originFit:
      "Origin makes planning output available through the local daemon. A later coding agent can recall the same decision record or existing distilled page when it is configured against the same daemon and space.",
    actionHeading: "Capture planning context",
    actionIntro:
      "Use Claude Desktop for high-level reasoning, then save the durable results.",
    actionBullets: [
      "First connect Claude Desktop with npx -y @7xuanlu/origin setup, ~/.origin/bin/origin mcp add claude-desktop, a Claude Desktop restart, and doctor/capture/recall verification.",
    ...
    faq: [
      "Is Claude Desktop required for Origin?",
      "No. It is one MCP client path. Origin can also serve Claude Code, Cursor, Codex, Gemini CLI, VS Code, and others.",
      "Does Claude Desktop support Origin slash commands?",
      "No. Claude Desktop uses MCP tools. Origin slash commands like /brief, /handoff, /distill, and /init are part of the Claude Code plugin workflow.",
    ],
  ...
  {
    slug: "origin-gemini-cli-workflow",
    eyebrow: "Workflow",
    category: "Workflows",
    title: "Origin Workflow for Gemini CLI",
    description:
      "Connect Gemini CLI as an MCP client and use Origin for local capture, recall, and handoff-style notes.",
    metaTitle: "Origin Workflow for Gemini CLI | MCP Memory",
    metaDescription:
      "Use Origin's local MCP memory layer with Gemini CLI for context, capture, recall, and cross-session handoffs.",
    keywords: [
      "Gemini CLI memory",
    ...
    actionHeading: "Use Gemini CLI with Origin",
    actionIntro:
  ...
  {
    slug: "origin-vscode-mcp-workflow",
    eyebrow: "Workflow",
    category: "Workflows",
    title: "Origin Workflow for VS Code MCP Clients",
    description:
      "Use Origin as a local memory server from VS Code surfaces that support MCP.",
    metaTitle: "Origin Workflow for VS Code MCP Clients | Origin",
    metaDescription:
      "Connect VS Code MCP clients to Origin and use one local memory layer for context, capture, recall, and project handoff.",
    keywords: [
      "VS Code MCP memory",
      "VS Code AI memory",
      "Origin VS Code workflow",
  ...
  },
  {
    ...
    eyebrow: "Workflow",
    category: "Workflows",
    title: "Claude Code Session Handoff with Origin",
    description:
      "Close Claude Code sessions with enough context for the next agent to resume without replaying the chat.",
    metaTitle: "Claude Code Session Handoff | Origin",
    metaDescription:
      "Use Origin /handoff in Claude Code to preserve decisions, lessons, gotchas, open threads, and project status for the next session.",
    keywords: [
      "Claude Code handoff",
    ...
    relatedSlugs: ["ai-agent-handoff-loop", "origin-for-claude-code", "how-to-add-memory-to-claude-code"],
    officialReferences: [
      {
        label: "Origin daily workflow docs",
        href: "https://useorigin.app/docs/daily-workflow",
  ...
  },
  {
    ...
    metaTitle: "Shared Memory Between Cursor and Claude Code | Origin",
    metaDescription:
      "Origin lets Cursor and Claude Code use one local AI work memory layer through the daemon and MCP connector.",
    keywords: [
    ...
    faq: [
      ...
      "Yes, through Origin's local daemon and retrieval tools when both clients share the same store.",
  ...
  },
  {
    ...
    metaTitle: "Shared Memory Between Codex and Claude Code | Origin",
    metaDescription:
      "Origin lets Codex and Claude Code share one local AI work memory layer for decisions, gotchas, handoffs, and project context.",
    keywords: [
      "Codex Claude Code shared memory",
      "Codex Claude Code handoff",
      "shared memory AI coding agents",
      "Origin Codex Claude Code",
    ...
    relatedSlugs: ["how-to-give-codex-persistent-memory", "how-to-add-memory-to-claude-code", "origin-codex-workflow"],
    officialReferences: [
      {
        label: "Codex MCP docs",
        href: "https://developers.openai.com/codex/mcp",
  ...
  },
  {
    ...
    metaTitle: "Multi-Agent Memory Workflow That Stays Local | Origin",
    metaDescription:
      "Use Origin's daemon, MCP tools, spaces, capture, recall, handoff, and distill to coordinate multi-agent AI work locally.",
    keywords: [
      "multi-agent memory workflow",
      "local multi-agent memory",
      "AI agents shared memory",
      "MCP multi-agent memory",
      "Origin multi-agent workflow",
    ],
    ...
    faq: [
      "Does Origin assign tasks to agents?",
      "No. Origin is the local memory layer. Your agent workflow decides task assignment.",
      "How do I avoid cross-project leakage?",
      "Use spaces intentionally. Run origin doctor from the terminal to inspect resolver state, then verify with a same-space capture/recall round trip.",
    ],
    ...
    officialReferences: [
      ...
      {
        label: "Origin spaces docs",
        href: "https://useorigin.app/docs/spaces",
      },
      {
        label: "Origin agent profiles docs",
  ...
  },
  {
    ...
    metaTitle: "AI Agent Project Status Handoff | Origin",
    metaDescription:
      "Use Origin handoffs and captures to preserve project status, open threads, decisions, and next steps for future AI agents.",
    keywords: [
...
const comparisonArticles: BaseSpec[] = [
  {
    slug: "origin-vs-mcp-memory-service",
    eyebrow: "Comparison",
    category: "Comparisons",
    title: "Origin vs mcp-memory-service: Local AI Work Memory or Agent Pipeline Backend?",
    description:
      "Compare Origin with mcp-memory-service across user workflow, transports, storage control, and agent-pipeline scope.",
    metaTitle: "Origin vs mcp-memory-service | AI Memory Comparison",
    metaDescription:
      "Origin focuses on local AI work memory for users. mcp-memory-service is a broad self-hosted memory service for MCP, HTTP, and agent workflows.",
    keywords: [
      "Origin vs mcp-memory-service",
    ...
    heroBullets: [
      "Origin is a user-facing local work-memory layer.",
    ...
    faq: [
      "Is mcp-memory-service a direct Origin replacement?",
      "Not exactly. It overlaps on persistent memory, but it is more backend/service oriented while Origin is centered on local AI work continuity.",
      "Can both be useful?",
      "Yes. A team could use a backend memory service for agent infrastructure and still prefer Origin for personal local AI work sessions.",
    ],
    ...
    officialReferences: [
      ...
      {
        label: "Origin HTTP API docs",
        href: "https://useorigin.app/docs/http-api",
      },
      {
        label: "Origin project scope docs",
      ...
      rows: [
        {
          ...
          origin: "Individual AI power users and developers carrying work context across sessions.",
        ...
        },
        {
          ...
          origin: "Claude Code plugin, MCP clients, CLI, handoff loop, pages, spaces.",
          competitor: "REST API, MCP, CLI, dashboard, OAuth, and framework-oriented integrations.",
        },
        {
          dimension: "API surface",
          origin: "Local daemon HTTP API on 127.0.0.1:7878 for CLI, MCP, desktop, and local scripts; not positioned as a hosted SDK surface.",
          competitor: "REST and MCP are first-class integration surfaces for agent and app backends.",
        },
        {
          dimension: "Artifacts and indexes",
          origin: "Readable Markdown pages, session logs, source trails, local git history, and local DB indexes.",
          competitor: "Service-managed records, tags, graph, dashboard, and APIs.",
        },
        {
          dimension: "Best fit",
          origin: "Personal or project AI work memory that should stay local and inspectable.",
  ...
  {
    slug: "origin-vs-chatgpt-memory",
    eyebrow: "Comparison",
    category: "Comparisons",
    title: "Origin vs ChatGPT Memory: Built-In Personalization or Local AI Work Memory?",
    description:
      "Compare built-in assistant memory with Origin's local, inspectable, cross-tool work-memory layer.",
    metaTitle: "Origin vs ChatGPT Memory | Local AI Work Memory",
    metaDescription:
      "ChatGPT memory can personalize one assistant. Origin keeps AI work memory local, source-backed, inspectable, and usable across MCP clients.",
    keywords: [
      "Origin vs ChatGPT memory",
    ...
    comparisonTable: {
      ...
      rows: [
        {
          dimension: "Scope",
          origin: "Local AI work memory across MCP-compatible tools.",
          competitor: "Built-in memory and saved context inside ChatGPT.",
        },
        {
          dimension: "Inspectability",
          origin: "Readable local artifacts, source-backed pages, and git history.",
          competitor: "Managed through product UI and account settings.",
        },
        {
          dimension: "Best fit",
          origin: "Project decisions, handoffs, local context, and cross-tool reuse.",
        ...
        },
        {
          ...
          origin: "Local daemon and ~/.origin artifacts by default.",
  ...
  {
    slug: "origin-vs-notion-ai",
    eyebrow: "Comparison",
    category: "Comparisons",
    title: "Origin vs Notion AI: Local AI Work Memory or Team Workspace AI?",
    description:
      "Compare Origin's local AI work memory with Notion AI's workspace, agents, meetings, and enterprise search features.",
    metaTitle: "Origin vs Notion AI | Local AI Work Memory",
    metaDescription:
      "Notion AI works from hosted workspace content and Notion MCP. Origin stores the AI work memory layer locally by default for MCP clients.",
    keywords: [
      "Origin vs Notion AI",
    ...
    heroBullets: [
      ...
      "Origin is built around local AI work context across tools.",
      "The right choice depends on whether the source of truth is a team workspace or your local agent workflow.",
    ],
    quickAnswer:
      "Use Notion AI when your work lives in Notion and you need workspace agents, AI Meeting Notes, enterprise search, hosted Notion MCP, and team governance. Use Origin when the memory layer should be stored locally by default and move across coding agents and MCP clients.",
    problem:
    ...
    originFit:
      "Origin is not a company workspace. It is the local memory layer for AI work: captures, handoffs, source-backed pages, and retrieval context across Claude Code, Cursor, Codex, Claude Desktop, and other clients.",
    ...
    actionBullets: [
      ...
      "Choose Origin for local project memory, code-agent handoffs, MCP clients, and inspectable ~/.origin artifacts.",
      "Use both if Notion is your team workspace and Origin is your AI coding memory layer.",
      "Do not duplicate everything across both; capture the consequence that future AI work needs.",
    ],
    caution:
      "Team workspace governance and local-first control solve different problems. Origin stores the memory layer locally by default, but connected AI clients may still send retrieved context to their model providers.",
    faq: [
      "Can Notion AI replace Origin for coding-agent memory?",
      "Not directly. Notion MCP can connect external AI tools to Notion workspace content, but the source of truth remains the hosted workspace. Origin is designed around a local daemon and ~/.origin artifacts.",
      "Can Origin replace Notion?",
      "No. Origin is not a workspace, docs database, calendar, or project-management suite.",
    ],
    relatedSlugs: ["ai-work-memory-vs-knowledge-base", "local-first-ai-memory", "origin-vs-obsidian-ai-memory"],
    officialReferences: [
      {
  ...
  },
  {
    ...
    eyebrow: "Comparison",
    category: "Comparisons",
    title: "Origin vs Mem0: Personal AI Work Memory or App Memory Infrastructure?",
    description:
      "Compare Origin's local AI work-memory loop with Mem0's memory infrastructure for AI agents and applications.",
    metaTitle: "Origin vs Mem0 | AI Memory Comparison",
    metaDescription:
      "Mem0 is memory infrastructure for agents and apps. Origin is local-first memory for AI work across Claude Code, Cursor, Codex, and MCP clients.",
    keywords: [
      "Origin vs Mem0",
      "Mem0 alternative",
    ...
    heroBullets: [
      ...
      "Origin positions as local-first memory for AI work.",
      "Choose by whether you need managed/app memory, self-hosted infrastructure, or a local personal work loop.",
    ],
    quickAnswer:
      "Choose Mem0 Platform when you are adding managed memory to an AI application or agent product, Mem0 Open Source when you want to self-host that stack, and Mem0 MCP/OpenMemory when you want Mem0 memory through coding agents. Choose Origin when you want a local daemon, source-backed pages, handoffs, readable artifacts, and git/provenance for your own AI work sessions.",
    problem:
    ...
    originFit:
      "Origin deliberately avoids being a generic memory infrastructure SDK. It is the local work-memory layer for people using Claude Code, Cursor, Codex, Claude Desktop, and other MCP clients against a local daemon.",
    ...
    actionBullets: [
      ...
      "Choose Origin for local AI work continuity and inspectable artifacts.",
      "Use Origin when handoffs, spaces, pages, and local git history matter.",
    ...
    faq: [
      "Is Origin an SDK for app developers?",
      "No. Origin is for people using AI daily, not as a backend for other apps building memory features.",
      "Can a developer use both?",
      "Yes. A developer might use Mem0 in an app and Origin for their own coding-agent work loop.",
    ],
    relatedSlugs: ["ai-agent-memory-local-vs-cloud", "project-scope-ai-memory", "origin-vs-mcp-memory-service"],
    officialReferences: [
      {
    ...
    comparisonTable: {
      ...
      rows: [
        {
          dimension: "Primary user",
          origin: "AI power users and developers carrying their own work context.",
        ...
        },
        {
          ...
          origin: "Local daemon, MCP connector, Claude Code plugin, pages, git history.",
        ...
        },
        {
          ...
          origin: "Origin MCP talks to a local daemon and local store.",
...
const trustArticles: BaseSpec[] = [
  {
    ...
    metaTitle: "Source-Backed Wiki Pages for AI Work | Origin",
    metaDescription:
      "Origin distilled pages store source memory IDs and keep revision state so AI work memory becomes readable without losing provenance.",
    keywords: [
  ...
  },
  {
    ...
    metaTitle: "AI Memory Provenance: Why Source IDs Matter | Origin",
    metaDescription:
    ...
    faq: [
      ...
      "Use Origin page-source views or APIs for page sources, and use recall/review surfaces for atomic memory records and corrections.",
    ],
  ...
  },
  {
    ...
    metaTitle: "Local Git History for AI Memory Artifacts | Origin",
    metaDescription:
      "Origin keeps real local git history for readable pages, session logs, and project status Markdown so AI work artifacts can be inspected and recovered.",
    keywords: [
    ...
    faq: [
      "Is Origin using git as the database?",
      ...
      "You can inspect and recover readable artifacts with git, but use Origin commands for normal memory correction, review, and forget flows.",
    ],
  ...
  },
  {
    ...
    metaTitle: "Review Before Trust in AI Memory | Origin",
    metaDescription:
      "Origin treats AI memory trust as a workflow: review pending captures, revisions, contradictions, supersession, and forget before stale context steers work.",
    keywords: [
      "review AI memory",
      "AI memory trust",
      "pending AI memories",
    ...
    originFit:
      "Origin separates review surfaces: list_pending for unconfirmed captures, revision/refinement queues for proposed changes or contradictions, quality-gate rejection logs for diagnostics, and forget for destructive deletion.",
  ...
  },
  {
    ...
    eyebrow: "Trust",
    category: "Concepts",
    title: "Project Scope for AI Memory in Origin",
    description:
      "Understand how Origin scopes local AI work memory with spaces, project context, and deliberate product boundaries.",
    metaTitle: "Project Scope for AI Memory | Origin",
    metaDescription:
      "Origin scopes to local-first AI work memory. It is not a life OS, workflow suite, generic memory infrastructure SDK, or one-off chat tool.",
    keywords: [
      "what Origin is not",
      "AI memory scope",
    ...
    audience: "Users deciding whether Origin fits their actual problem",
    heroBullets: [
      "Origin scopes to AI work artifacts and project spaces.",
      "It does not try to become a life OS or full workflow suite.",
      "It is for repeated AI work, not one-off chats.",
    ],
    quickAnswer:
      "Origin is local-first memory for repeated AI work. Use spaces as project/client buckets, not account permissions or team governance. It is not a life OS, not a general workflow suite, not a generic memory infrastructure SDK, and not needed for one-off chats.",
    problem:
      "Many AI tools blur scope until users cannot tell what problem they solve. Clear boundaries make Origin easier to choose and easier to reject.",
    originFit:
      "Origin focuses on decisions, lessons, gotchas, project context, handoffs, source-backed pages, and retrieval across MCP clients configured against the same daemon, data dir, and active space.",
    actionHeading: "Use Origin when the scope matches",
    actionIntro:
      "Choose Origin for repeated work that needs continuity.",
    actionBullets: [
      "Use Origin for multi-session AI work.",
      "Use Origin when local, inspectable memory matters.",
      "Use spaces for project, client, or context buckets that should not automatically inform each other.",
      "Do not use Origin as a calendar, habit tracker, or full personal OS.",
      "Do not use Origin as a generic backend SDK for app memory.",
      "Skip Origin for one-off chats with no future context.",
    ],
    caution:
      "A narrow scope is a product feature. Local-first keeps Origin's memory layer local by default, but connected AI clients may still send retrieved context to their own model providers.",
    faq: [
      "Why state what Origin is not?",
      "Because honest scope prevents bad installs and makes the product easier to trust.",
      "Can Origin still work beside broader tools?",
      "Yes. Use Origin for local AI work memory and other tools for notes, tasks, calendars, or app infrastructure.",
    ],
    relatedSlugs: ["ai-work-memory", "origin-vs-mem0", "persistent-project-context-for-ai-agents"],
    officialReferences: [
      {
        label: "Origin project scope docs",
        href: "https://useorigin.app/docs/project-scope",
