          ...
          <nav aria-label="Site footer" className="grid gap-8 sm:grid-cols-4">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link href="/docs/get-started" className="text-[var(--o-text-secondary)] transition-colors hover:text-[var(--o-warm)]">Get started</Link></li>
                <li><Link href="/docs/daily-workflow" className="text-[var(--o-text-secondary)] transition-colors hover:text-[var(--o-warm)]">Daily workflow</Link></li>
                <li><Link href="/docs" className="text-[var(--o-text-secondary)] transition-colors hover:text-[var(--o-warm)]">Docs</Link></li>
                <li><Link href="/learn" className="text-[var(--o-text-secondary)] transition-colors hover:text-[var(--o-warm)]">Learn</Link></li>
              </ul>
            </div>
            <div>
              <p className="mb-3 font-mono text-[10px] tracking-[0.24em] text-[var(--o-text-muted)] uppercase">
              ...
              <ul className="space-y-2 text-sm">
                <li><Link href="/learn/origin-vs-basic-memory" className="text-[var(--o-text-secondary)] transition-colors hover:text-[var(--o-warm)]">vs Basic Memory</Link></li>
                <li><Link href="/learn/origin-vs-claude-mem" className="text-[var(--o-text-secondary)] transition-colors hover:text-[var(--o-warm)]">vs claude-mem</Link></li>
                <li><Link href="/learn/origin-vs-superlocal-memory" className="text-[var(--o-text-secondary)] transition-colors hover:text-[var(--o-warm)]">vs Superlocal Memory</Link></li>
              </ul>
            </div>
            <div>
              <p className="mb-3 font-mono text-[10px] tracking-[0.24em] text-[var(--o-text-muted)] uppercase">
              ...
              <ul className="space-y-2 text-sm">
                <li><Link href="/about" className="text-[var(--o-text-secondary)] transition-colors hover:text-[var(--o-warm)]">About</Link></li>
                <li>
                  <a href="https://github.com/7xuanlu/origin" target="_blank" rel="noopener noreferrer" className="text-[var(--o-text-secondary)] transition-colors hover:text-[var(--o-warm)]">
                    GitHub
                  </a>
                </li>
                <li>
                  <a href="/feed.xml" className="text-[var(--o-text-secondary)] transition-colors hover:text-[var(--o-warm)]">RSS feed</a>
                </li>
                <li>
                  <a href="https://github.com/7xuanlu/origin/blob/main/LICENSE" target="_blank" rel="noopener noreferrer license" className="text-[var(--o-text-secondary)] transition-colors hover:text-[var(--o-warm)]">
                    Apache-2.0
                  </a>
                </li>
              </ul>
