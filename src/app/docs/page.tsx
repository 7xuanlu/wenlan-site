...
const docsSections = [
  ...
  },
  {
    title: "Reference",
    description:
      "Commands, CLI/service management, updates, platform support, HTTP API, spaces, pages, import paths, git history, retrieval status, local data, backup paths, configuration, MCP clients, diagnostics, and repair paths.",
    items: docPages
  ...
  },
  {
    title: "Project",
    description:
      "Security reporting, evaluation, releases, roadmap, project scope, source builds, and contribution paths for people deciding whether Origin is credible enough to adopt or contribute to.",
    items: docPages
