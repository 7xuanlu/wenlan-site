...
const zhTWArticles = {
  "prevent-multi-agent-knowledge-conflicts": {
    ...
    metaDescription:
      "多個 AI Agent 共用知識庫容易互相覆寫、採用缺乏證據的主張，或在來源改變後繼續沿用過期結論。用證據審查、候選主張、版本檢查、人工審核與歷史記錄，建立不會默默腐壞的共享知識。",
    keywords: [
      "多個 AI Agent 共用知識衝突",
      "避免共享 AI 知識過期",
      "AI Agent 記憶衝突",
...
/pages <主題>`,
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "原子知識與來源連結讓頁面有依據可查。頁面重建會產生新版本；來源連結與版本紀錄方便比較變更，不代表模型已正確處理每個數字或來源衝突。",
        ],
      },
      {
      ...
      },
      {
        heading: "如何處理過期與衝突",
        body: [
          "來源或工作條件改變時，先區分明確的版本替代與仍然有效的不同來源。舊結論需要重新核對；若兩個來源仍有分歧，保留兩邊的依據，不要擅自合成一個確定答案。",
  ...
  "coding-agent-source-backed-knowledge-base": {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "準備一個來源中有答案的問題、一個必須跨兩份文件才能回答的問題，以及一個來源沒有答案的問題。前兩者不只要顯示來源 ID，還要確認引用段落真的支持每個說法；最後一個應保持未知，不應因為文字流暢就補成確定結論。",
          "更新該 Page 已引用的一份來源，再確認 Page 明確進入 stale、refresh 或 review。另存一筆帶 supersedes 的新紀錄可以保留歷史，但不能假設它會自動讓仍連到舊來源的 Page 過期；重建後仍要人工審查。",
        ],
      },
      {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "不可以。程式、測試、規格與核准的第一方文件仍是權威；來源 ID 只是指標，不代表頁面說法已被來源證明。更新被引用的來源後，應確認知識頁真的進入 stale，再重建與審查。",
      },
      {
  ...
  "choose-ai-knowledge-base-tool": {
    ...
    metaDescription:
      "文件問答、RAG、筆記工具、維護型知識庫，到底哪種適合你？先分清四種工具的本質差異，再用 8 個實際測試——來源追溯、更新機制、審查流程、資料控制與實測結果——選出經得起檢驗的 AI 知識庫工具。",
    keywords: [
      "AI 知識庫工具",
      "AI 知識庫軟體推薦",
      "如何選 AI 知識庫",
  ...
  "fix-pdf-ingestion-ai-knowledge-base": {
    ...
    metaDescription:
      "AI 知識庫匯入 PDF 失敗別急著重傳：先判斷是掃描型 PDF、文字層缺失、OCR 辨識問題、檔案大小限制，還是解析錯誤與空內容。按步驟排查文字層、OCR 設定與解析結果，並驗證實際引用來源，多數匯入問題都能一次定位。",
    keywords: [
      "AI 知識庫 PDF 匯入失敗",
      "掃描 PDF AI 知識庫 OCR",
      "PDF 文字擷取失敗",
  ...
  "when-ai-agent-should-query-knowledge-base": {
    ...
    metaDescription:
      "AI Agent 什麼時候該查知識庫、什麼時候該略過？用一套判斷流程決定何時檢索、何時先看索引、何時直接打開確切來源：需要證據時讀得到，不需要時不把無關文件塞進上下文，省下 token 又保留答案的可追溯性。",
    keywords: [
      "AI Agent 何時查知識庫",
      "AI 知識庫檢索策略",
      "AI 知識庫 token 成本",
    ...
    author: "Qi-Xuan Lu",
    readingTime: "8 分鐘閱讀",
    audience: "需要讓 AI Agent 反覆查閱大型文件、專案資料或內部規範的開發者",
    heroBullets: [
  ...
  "test-ai-knowledge-base-retrieval-after-changes": {
    ...
    metaDescription:
      "AI 知識庫改版後檢索品質掉了怎麼辦？用版本化的黃金問題集與預期來源，對比語料、embedding、切塊、混合檢索或 reranker 改動前後的 Recall@k、MRR，並用無答案案例、失敗分類與回滾機制做回歸測試。",
    keywords: [
      "RAG 檢索回歸測試",
      "RAG 黃金資料集",
      "AI 知識庫召回準確率怎麼測",
  ...
  "verify-ai-knowledge-base-citations": {
    ...
    metaDescription:
      "AI 知識庫回答的引用對不上？把 RAG 回答拆成可逐項檢查的主張，診斷錯頁、錯片段、過期版本與沒有證據支持的結論。建立可重複的來源檢查流程，讓每次引用都有據可查，不再被幻覺引用誤導。",
    keywords: [
      "AI 知識庫引用對不上",
      "驗證 AI 知識庫引用",
      "AI 知識庫回答沒有依據",
  ...
  "source-backed-research-knowledge-base": {
    ...
    metaDescription:
      "用已選定的論文與文字型 PDF 建立可追溯的研究知識庫：保留文獻矩陣、研究方法、精確引用、矛盾觀點、研究限制與來源更新。寫論文或報告時每個主張都能找到出處，審稿人追問也不怕。",
    keywords: [
      "用論文 PDF 建立研究知識庫",
      "AI 論文筆記保留引用",
      "論文大腦 文獻回顧",
  ...
  "build-client-project-knowledge-base-for-consulting": {
    ...
    metaDescription:
      "為單一顧問客戶建立可追溯、可更新的專案知識庫：集中整理研究來源、訪談筆記、決策脈絡、交付物與交接事項，標示過期證據與負責人。新成員接手不必重新問一遍，專案結束後經驗也不會跟著人離開。",
    keywords: [
      "顧問 客戶專案 知識庫",
      "顧問案 研究資料 交接",
      "客戶研究 知識庫 引用",
  ...
  "build-investment-research-knowledge-base": {
    ...
    metaDescription:
      "用財報、年報與法說會資料建立有來源的投資研究知識庫：把研究問題、引用出處與投資論點整理成可追溯的公司檔案，新證據出現時更新論點並保留變更紀錄，過期證據定期審查，不再憑印象做判斷。",
    keywords: [
      "投資研究知識庫",
      "AI 財報研究工作流",
      "年報 法說會 研究筆記",
  ...
  "build-product-research-knowledge-base-for-prd": {
    ...
    metaDescription:
      "寫 PRD 前先建立產品研究知識庫：把核准的研究筆記、客服與業務訊號、過往決策整理成有來源的證據庫，保留日期、需求脈絡、矛盾、假設、待解問題與決策歷史，讓每份 PRD 在審查時都有據可查、可辯護。",
    keywords: [
      "產品研究知識庫",
      "使用者研究到 PRD",
      "產品決策來源",
    ...
    productEvidence: {
      ...
      image: {
        ...
        caption:
          "Wenlan App 的真實測試畫面：這是通用產品示例，不是產品研究專案的完成成果。Page 列表顯示來源數量，審查佇列保留來源衝突與待處理的新來源。",
        width: 1586,
        height: 992,
      },
      workflow: [
  ...
  "build-sre-incident-knowledge-base": {
    ...
    metaDescription:
      "用 runbook 與事故復盤建立有來源的 SRE 事故知識庫：把值班筆記整理成可審查、不會默默過期的知識，保留修訂紀錄、驗證訊號、過期狀態與安全邊界。下次 on-call 遇到相似事故，直接查得到上次怎麼解的。",
    keywords: [
      "SRE 事故知識庫",
      "runbook 知識庫",
      "事故復盤 知識沉澱",
  ...
  "build-competitive-intelligence-knowledge-base": {
    ...
    metaDescription:
      "從獲准的文件、產品手冊與 release notes 建立競品研究知識庫：用有界的來源登錄表、日期與修訂，整理可審查的競品情報，保留來源日期、修訂紀錄、過期主張與人工審查，讓過期資訊與矛盾觀點保持可見。",
    keywords: [
      "競品分析知識庫",
      "競品研究知識庫",
      "競爭情報資料整理",
  ...
  "build-ict-supplier-due-diligence-evidence-pack": {
    ...
    metaDescription:
      "為軟體供應商建立資安盡職調查證據包：把核准文件整理成可追溯的檔案，清楚標示來源、服務範圍、風險缺口、負責人、待確認事項與複審日期。稽核來時一次拿得出完整證據，不用臨時翻箱倒櫃。",
    keywords: [
      "ICT 供應商資安盡職調查",
      "軟體供應商資安評估",
      "供應商風險評估問卷",
  ...
  "build-customer-support-answer-knowledge-base": {
    ...
    metaDescription:
      "從核准的產品與政策文件建立客服答案知識庫：產品或政策變更後，用適用範圍、不可承諾事項、轉人工條件、負責人與複審日期維護可檢查的客服答案。每個回答保留問題、支持依據與來源修訂，客服不再各說各話。",
    keywords: [
      "客服知識庫",
      "客服話術知識庫",
      "客服知識庫更新",
  ...
  "build-course-wiki-from-lecture-notes": {
    ...
    metaDescription:
      "從課堂講義、課件與可擷取文字的 PDF 建立有來源的課程 Wiki：把一門課的概念、先備知識整理成可維護的頁面，保留引用出處、來源修訂與複核狀態。期末複習或開新課時，直接有一份可信的知識底。",
    keywords: [
      "把課堂講義整理成 AI 知識庫",
      "講義 PDF 轉學習筆記",
      "學生 LLM Wiki",
  ...
  "build-business-metric-definition-knowledge-base": {
    ...
    metaDescription:
      "從核准的 KPI 規格檔案建立可複核的指標定義知識庫：把公式文字、粒度、維度、排除條件、負責人、引用、版本與取代關係整理成有來源的資料字典。指標口徑爭議時，直接查定義不再各說各話。",
    keywords: [
      "建立商業指標定義知識庫",
      "資料字典 指標口徑",
      "AI agent 指標定義",
...
const zhCNArticles = {
  "prevent-multi-agent-knowledge-conflicts": {
    ...
    metaDescription:
      "多个 AI Agent 共享知识库容易互相覆盖、采用缺乏证据的主张，或在来源变化后继续沿用过期结论。用证据审核、候选主张、版本检查、人工审核与历史记录，建立不会悄悄腐坏的共享知识。",
    keywords: [
      "多智能体共享知识冲突",
      "避免共享 AI 知识过期",
      "AI Agent 记忆冲突",
  ...
  "fix-pdf-ingestion-ai-knowledge-base": {
    ...
    metaDescription:
      "AI 知识库导入 PDF 失败别急着重传：先判断是扫描件、文本层缺失、OCR 识别问题、文件大小限制，还是解析错误与空内容。按步骤排查文本层、OCR 设置与解析结果，并验证实际引用来源，多数导入问题都能一次定位。",
    keywords: [
      "AI 知识库 PDF 导入失败",
      "扫描 PDF AI 知识库 OCR",
      "PDF 文本提取失败",
  ...
  "when-ai-agent-should-query-knowledge-base": {
    ...
    metaDescription:
      "AI Agent 什么时候该查知识库、什么时候该跳过？用一套判断流程决定何时检索、何时先看索引、何时直接打开准确来源：需要证据时读得到，不需要时不把无关文档塞进上下文，省下 token 又保留答案的可追溯性。",
    keywords: [
      "AI Agent 什么时候查询知识库",
      "AI 知识库检索策略",
      "AI 知识库上下文成本",
    ...
    author: "Qi-Xuan Lu",
    readingTime: "8 分钟阅读",
    audience: "需要让 AI Agent 反复查阅大型文档、项目资料或内部制度的开发者",
    heroBullets: [
...
/pages <主题>`,
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "原子知识与来源链接让页面有依据可查。页面重建会产生新版本；来源链接与版本记录方便比较变化，不代表模型已正确处理每个数字或来源冲突。",
        ],
      },
      {
      ...
      },
      {
        heading: "如何处理过期与冲突",
        body: [
          "来源或工作条件改变时，先区分明确的版本替代与仍然有效的不同来源。旧结论需要重新核对；如果两个来源仍有分歧，保留双方依据，不要擅自合成一个确定答案。",
  ...
  "coding-agent-source-backed-knowledge-base": {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "准备一个来源中有答案的问题、一个必须跨两份文档才能回答的问题，以及一个来源没有答案的问题。前两者不只要显示来源 ID，还要确认引用段落确实支持每个说法；最后一个应保持未知，不应因为文字流畅就补成确定结论。",
          "更新该 Page 已引用的一份来源，再确认 Page 明确进入 stale、refresh 或 review。另存一条带 supersedes 的新记录可以保留历史，但不能假设它会自动让仍连接旧来源的 Page 过期；重建后仍需人工审核。",
        ],
      },
      {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "不可以。代码、测试、规范与批准的第一方文档仍是权威；来源 ID 只是指针，不代表页面说法已被来源证明。更新被引用的来源后，应确认知识页面确实进入 stale，再重建与审核。",
      },
      {
  ...
  "choose-ai-knowledge-base-tool": {
    ...
    metaDescription:
      "文档问答、RAG、笔记工具、维护型知识库，到底哪种适合你？先分清四种工具的本质差异，再用 8 个实际测试——来源追溯、更新机制、审核流程、数据控制与实测结果——选出经得起检验的 AI 知识库工具。",
    keywords: [
      "AI 知识库工具",
      "AI 知识库软件推荐",
      "如何选 AI 知识库",
  ...
  "test-ai-knowledge-base-retrieval-after-changes": {
    ...
    metaDescription:
      "AI 知识库改版后召回质量掉了怎么办？用版本化的黄金问题集与预期来源，对比语料、Embedding、切分、混合检索或 reranker 改动前后的 Recall@k、MRR，并用无答案案例、失败分类与回滚机制做回归测试。",
    keywords: [
      "RAG 召回回归测试",
      "RAG 黄金评测集",
      "知识库检索怎么评测",
  ...
  "verify-ai-knowledge-base-citations": {
    ...
    metaDescription:
      "AI 知识库回答的引用对不上？把 RAG 回答拆成可逐项检查的主张，诊断错页、错片段、过期版本与没有证据支持的结论。建立可重复的来源检查流程，让每次引用都有据可查，不再被幻觉引用误导。",
    keywords: [
      "AI 知识库引用对不上",
      "验证 AI 知识库引用",
      "知识库回答无依据",
  ...
  "source-backed-research-knowledge-base": {
    ...
    metaDescription:
      "用已经选定的论文与文本型 PDF 建立可追溯的研究知识库：保留文献矩阵、研究方法、准确引用、矛盾观点、研究局限与来源更新。写论文或报告时每个主张都能找到出处，审稿人追问也不怕。",
    keywords: [
      "用论文 PDF 建立研究知识库",
      "AI 论文笔记保留引用",
      "论文知识库 文献综述",
  ...
  "build-client-project-knowledge-base-for-consulting": {
    ...
    metaDescription:
      "为单一咨询客户建立可追溯、可更新的项目知识库：集中整理调研来源、访谈笔记、决策脉络、交付物与交接事项，标注过期证据与负责人。新成员接手不必重新问一遍，项目结束后经验也不会跟着人离开。",
    keywords: [
      "咨询顾问 客户项目 知识库",
      "咨询项目 调研资料 交付",
      "客户研究 知识库 来源引用",
  ...
  "build-investment-research-knowledge-base": {
    ...
    metaDescription:
      "用财报、年报、公告与业绩说明材料建立有来源的投资研究知识库：把研究问题、引用出处与投资论点整理成可追溯的公司档案，新证据出现时更新论点并保留变更记录，过期证据定期审核，不再凭印象做判断。",
    keywords: [
      "AI 投研知识库",
      "财报 研报 公告 知识库",
      "投资研究知识库",
  ...
  "build-product-research-knowledge-base-for-prd": {
    ...
    metaDescription:
      "写 PRD 前先建立产品研究知识库：把批准的研究笔记、客服与销售信号、过往决策整理成有来源的证据库，保留日期、需求脉络、矛盾、假设、待解问题与决策历史，让每份 PRD 在评审时都有据可查、可辩护。",
    keywords: [
      "产品研究知识库",
      "用户研究到 PRD",
      "产品决策依据",
    ...
    productEvidence: {
      ...
      image: {
        ...
        caption:
          "Wenlan App 的真实测试画面：这是通用产品示例，不是产品研究项目的完成成果。Page 列表显示来源数量，评审队列保留来源冲突和待处理的新来源。",
        width: 1586,
        height: 992,
      },
      workflow: [
  ...
  "build-sre-incident-knowledge-base": {
    ...
    metaDescription:
      "用 runbook 与故障复盘建立有来源的 SRE 故障知识库：把值班笔记整理成可审核、不会悄悄过期的知识，保留修订记录、验证信号、过期状态与安全边界。下次 on-call 遇到类似故障，直接查得到上次怎么解的。",
    keywords: [
      "SRE 故障知识库",
      "runbook 知识库",
      "故障复盘 知识沉淀",
  ...
  "build-competitive-intelligence-knowledge-base": {
    ...
    metaDescription:
      "从获准的文档、产品手册与 release notes 建立竞品调研知识库：用有边界的来源登记表、日期与修订，整理可审核的竞品情报，保留来源日期、修订记录、过期主张与人工审核，让过期信息与矛盾观点保持可见。",
    keywords: [
      "竞品分析知识库",
      "竞品调研资料库",
      "竞品信息更新",
  ...
  "build-ict-supplier-due-diligence-evidence-pack": {
    ...
    metaDescription:
      "为软件供应商建立安全尽职调查证据包：把批准文件整理成可追溯的档案，清楚标注来源、服务范围、风险缺口、负责人、待确认事项与复审日期。审计来时一次拿得出完整证据，不用临时翻箱倒柜。",
    keywords: [
      "ICT 供应商安全尽职调查",
      "软件供应商安全评估",
      "供应商风险评估问卷",
  ...
  "build-customer-support-answer-knowledge-base": {
    ...
    metaDescription:
      "从获准的产品与政策文档建立客服答案知识库：产品或政策变化后，用适用范围、禁止承诺事项、转人工条件、负责人与复审日期维护可检查的客服答案。每个回答保留问题、支持依据与来源修订，客服不再各说各话。",
    keywords: [
      "客服知识库",
      "客服话术知识库",
      "客服知识库更新",
  ...
  "build-course-wiki-from-lecture-notes": {
    ...
    metaDescription:
      "从课程讲义、课件与可提取文本的 PDF 建立有来源的课程 Wiki：把一门课的概念、前置知识整理成可维护的页面，保留引用出处、来源修订与审核状态。期末复习或开新课时，直接有一份可信的知识底。",
    keywords: [
      "把课程讲义整理成 AI 知识库",
      "课件 PDF 转学习笔记",
      "学生 LLM Wiki",
  ...
  "build-business-metric-definition-knowledge-base": {
    ...
    metaDescription:
      "从获准的 KPI 规范文件建立可审核的指标定义知识库：把公式文本、粒度、维度、排除条件、负责人、引用、版本与替代关系整理成有来源的数据字典。指标口径争议时，直接查定义不再各说各话。",
    keywords: [
      "建立业务指标定义知识库",
      "数据字典 指标口径",
      "AI agent 指标定义",
