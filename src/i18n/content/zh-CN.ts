...
export const zhCNContent = {
  ...
  home: {
    status: "translated",
    sourceHash: "572afd2f2a683f2ef299620ab880736b98c8e8aeffdefcc42b3eb3ee819e27c6",
    content: {
      seo: {
        title: "Wenlan 文澜 | AI 工作的 LLM wiki",
        description:
          "Wenlan 文澜是有来源依据的 AI 知识库，也是 AI 工作的 LLM wiki：整理文档与决策，让你和 AI 能查找、核对与审核页面。",
      },
      nav: {
      ...
      download: {
        ...
        description:
          "Wenlan v0.18.4 提供 Windows x64 桌面版与 macOS Apple silicon DMG，以及 Windows、macOS、Linux 的 headless runtime 包。",
        stableLabel: "稳定版",
      ...
      redesign: {
        hero: {
          ...
          description:
            "文澜把文档、笔记与工作中积累的决策，整理成有来源、能持续更新的 Wiki。让你和 AI 不只是找回资料，更能基于已有的理解，接着往前做。",
          worksWithLabel: "可搭配",
  ...
  about: {
    status: "translated",
    sourceHash: "b18773e227d2207cbcae8d39d0f50a0f992f1eecc6b56e3863f57c946cb3e837",
    content: {
      seo: {
      ...
      hero: {
        ...
        statusLabel: "项目状态",
        statusItems: ["版本 v0.18.4", "支持 macOS、Linux、Windows", "Apache-2.0", "Qi-Xuan Lu 构建"],
      },
      sections: [
        {
          id: "why",
        ...
        },
        {
          ...
          title: "当前状态",
          paragraphs: [
            "Wenlan v0.18.4 提供已公证的 macOS Apple Silicon DMG 与 Windows x64 桌面版，以及 macOS、Linux (x86_64, aarch64; glibc) 和 Windows (x86_64) 原生 headless runtime 包。Windows 用户可以选择桌面版 setup 安装程序或 headless runtime ZIP。daemon、CLI、MCP server、Claude Code plugin 与 Codex plugin 采用 Apache-2.0；桌面 App crate 采用 AGPL-3.0-only。",
          ],
        },
      ],
      principles: {
  ...
  getStarted: {
    status: "translated",
    sourceHash: "557df52f066be2eea6ec34ff40cc42b2ec8b15dab1ebc5c79a6eac07a56ca802",
    content: {
      seo: {
      ...
      steps: [
        {
          ...
          paragraphs: [
            "Wenlan v0.18.4 提供 Windows x64、macOS Apple silicon，以及 Linux x64 或 ARM64 glibc 的原生 runtime 包。每份 runtime archive 都包含 CLI、daemon 与 MCP connector。",
          ...
          ctas: [
            ...
            {
              id: "all-downloads",
              href: "https://github.com/7xuanlu/wenlan/releases/tag/v0.18.4",
              label: "全部 v0.18.4 下载",
            },
          ],
        },
