  ...
  home: {
    ...
    content: {
      ...
      redesign: {
        ...
        pains: {
          "title": "選你的知識工作流程。",
          "intro": "不只比功能：看你在哪工作、什麼交得出去、什麼自己決定。",
          "scopeNote": "Wenlan 也是 LLM Wiki 實作，可搭配使用。",
          "dimensions": [
            "平常怎麼用？",
            "哪些整理會自動做？",
            "什麼時候要我決定？"
          ...
          "helpLabel": "更多背景",
          "accessNote": "先連來源與模型、建好首批 Pages，再用桌面 App，或 plugin／CLI＋本機 daemon。",
          "generations": [
            {
              "id": "wiki-graveyard",
              "name": "AI 工具＋文件",
  ...
  links: {
    ...
    content: {
      ...
      hero: {
        ...
        title: "所有文瀾官方連結。",
        description:
          "下載、文件、指南和程式碼都在這一個頁面，bio 裡的連結不會帶你到過時的地方。",
      },
      links: [
        {
          id: "download",
          href: "/download",
          label: "下載 Wenlan",
          description: "macOS、Windows、Linux 的桌面版與 headless 版本。",
        },
        {
          id: "get-started",
          href: "/docs/get-started",
          label: "新手上路指南",
          description: "幾分鐘內完成安裝、連接 AI 工具並驗證。",
        },
        {
          id: "learn",
          href: "/learn",
          label: "學習指南：AI 知識庫",
          description: "AI 工作與記憶的 source-backed LLM wiki 指南。",
        },
        {
          id: "docs",
          href: "/docs",
          label: "說明文件",
          description: "參考資料、設定與產品功能總覽。",
        },
        {
          id: "about",
          href: "/about",
          label: "關於文瀾",
          description: "文瀾為什麼存在，以及是誰在打造它。",
        },
        {
          id: "github",
          href: "https://github.com/7xuanlu/wenlan",
          label: "GitHub：7xuanlu/wenlan",
          description: "原始碼、議題與版本發佈。Apache-2.0。",
        },
        {
          id: "npm",
          href: "https://www.npmjs.com/package/wenlan",
          label: "npm：wenlan",
          description: "從 npm 安裝 CLI 與 MCP server。",
        },
      ],
      footnote: "只收錄官方連結。這裡的每一站都在 wenlan.app、github.com/7xuanlu 或 npmjs.com 上。",
    },
  },
  docs: {
    status: "translated",
