      ...
      groups: [
        {
          ...
          links: [
            ...
            { href: "/docs/capture-quality", label: "捕捉品質" },
            { href: "/docs/core-concepts", label: "核心概念" },
            { href: "/docs/data-and-privacy", label: "資料與隱私" },
            { href: "/docs/configuration", label: "設定" },
        ...
        },
        {
          ...
          links: [
            ...
            { href: "/learn/wenlan-vs-basic-memory", label: "與 Basic Memory 比較" },
            { href: "/learn/wenlan-vs-claude-mem", label: "與 claude-mem 比較" },
            {
        ...
        },
        {
          ...
          links: [
            { href: "/about", label: "關於" },
            { href: "/docs/architecture", label: "架構" },
            { href: "/docs/evaluation", label: "評估" },
            { href: "/docs/changelog", label: "變更記錄" },
            { href: "/docs/roadmap", label: "路線圖" },
            { href: "/docs/project-scope", label: "專案範疇" },
            { href: "/docs/security", label: "安全" },
            { href: "https://github.com/7xuanlu/wenlan", label: "GitHub" },
            { href: "/feed.xml", label: "RSS 訂閱" },
            {
